...
export const AuthProvider = ({ children }) => {
    ...
    const handleGoogleCallback = async (searchParams, directData = null) => {
        try {
            console.log('handleGoogleCallback called with:', { searchParams, directData });
            ...
            console.log('Setting token and dispatching login success:', { user: user.email, token: token.substring(0, 10) + '...' });
